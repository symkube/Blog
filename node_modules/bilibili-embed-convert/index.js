...
Bili_video.prototype.flashAddr = function(){
  return 'https://share.acg.tv/flash.swf?aid='
  + this.avnumber
  + '&page='
  + this.page;
}
...
Bili_video.prototype.embedAddr = function(){
    ...
    return '<embed height="'
      ...
      + '" width="'
      + width
      + '" quality="high" allowfullscreen="true" type="application/x-shockwave-flash" src="https://share.acg.tv/flash.swf" flashvars="aid='
      + this.avnumber
      + '&page='
      + this.page
      + '" pluginspage="https://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash"></embed>';
}
