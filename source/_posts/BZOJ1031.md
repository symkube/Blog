---
title: 「JSOI2007」「BZOJ-1031」字符加密-后缀数组
date: 2016-12-27 12:58:35
tags:
  - 字符串
  - 后缀数组
categories:
...
### 链接
[BZOJ1031](http://www.lydsy.com/JudgeOnline/problem.php?id=1031)
<!-- more -->
### 题解
我们只需要将字符串长度翻倍，使后半部分与前半部分相同，然后建立后缀数组，得到循环意义下每个串的排序，找到每个串的最后一个字符输出即可。
### 代码
``` cpp
#include <bits/stdc++.h>
#define FAST_IO
