---
title: 「BZOJ 4154」Generating Synergy-k-d 树
date: 2017-10-02 21:44:13
tags:
  - 数据结构
  - k-d树
categories:
...
### 链接
[BZOJ 4154](http://www.lydsy.com/JudgeOnline/problem.php?id=4154)
...
一些细节：我们可以记录 K-D 树的父亲节点及原树中节点对应 K-D 树中的节点，这样查询的时候我们只需要直接找到对应 K-D 树中的节点，然后沿 `fa` 跳回根下穿标记即可。
