---
title: 「CC MANYLIST」-树状数组 + map
date: 2018-05-12 11:41:56
tags:
  - 数据结构
categories:
  - OI
...
### 链接
[CC MANYLIST](https://www.codechef.com/problems/MANYLIST)

### 题解
对于每个数用 `map` 维护其出现的区间，每次新加一个区间，将旧的区间合并，并在树状数组上更新就好了。

由于区间一共有 $O(n)$ 个，故时间复杂度为 $O(n \log n)$。
