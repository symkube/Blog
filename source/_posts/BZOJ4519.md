---
title: 「BZOJ 4519」不同的最小割-GomoryHuTree
date: 2018-03-19 20:34:14
tags:
  - 网络流
categories:
  - OI
...
### 题解
建 [GomoryHu Tree](https://en.wikipedia.org/wiki/Gomory%E2%80%93Hu_tree)，方式就是先把除 $1$ 号点外的的点的父亲置为 $1$，然后每次取出其中一个点 $u$ 和它的父亲 $v$ 计算最小割，然后 bfs 残量网络，若满流且其父亲为 $v$，则把这个点的父亲置为 $u$。
